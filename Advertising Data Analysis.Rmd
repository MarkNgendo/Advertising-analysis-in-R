...
* Whether the ad is in text form orn not
...
```{r}
# correlation between Daily Internet usage an time spent on the site.

cor(df$Daily.Internet.Usage, df$Daily.Time.Spent.on.Site)
```

As is evident above, there is a correlation between how much time spends on the internet vs that on the site. It is not exactly a 1:1 correlation but it is positive.
